...
Local controls now retain reasoned major follow-up completion, unpaid ticket cancellation/restoration, administrative attendance correction and confirmed-unsent tribute withdrawal. Exact reviewed correspondence can be linked to a staff-confirmed manual acknowledgment. These are CRM documentary controls, not external execution. Unpaid/unfulfilled sponsorship cancellation/reopening and unpaid auction award reopening are now versioned and reasoned, preserving original promises/awards/bids without reversing gifts. Retained prior benefit completion protects cancellation even after unchecking. The 386/386 integrated test pass covers these documentary controls. Adopt paid/fulfilled/sent/default/bid-withdrawal or planned-instrument adjustment policies separately. Every release of a source lock must retain the original evidence and reason; a silent delete or overwrite is not a correction policy.
