# Wimblo — client testing guide

Use this local evaluator to review nonprofit fundraising workflows and record your observations. Wimblo is an independently branded nonprofit CRM by Kode Kinetics. This local testing workspace uses synthetic data.
