...
## Product Purpose
Create a working CRM proof of concept for Kode Kinetics LLC's evaluation of RFP 27TH05P5. Users should complete real saved workflows rather than inspect static mockups. The pilot must not be described as production-certified or as satisfying bidder experience requirements.

## Operating Context
Jordan Education Foundation nonprofit fundraising. Donation designations include schools, classrooms, programs, and foundation funds. Manual donation recording/import accommodates the district's stated bank-linking restriction. Record types and workflow requirements derive from the supplied RFP; actual live third-party integration credentials and migration exports are not provided.
...
## Brand Commitments
Kode Kinetics LLC, www.kodekinetics.com. User explicitly requests Impeccable and standard UI/UX conventions; build directly in code and review finished screens. Kinflect is a tailored evaluator product name selected under the user’s naming authorization, not an official JSD brand or endorsement. Do not fabricate official logos, customers, references, or compliance certifications.
